...
btnChart2 = tk.Button(window, text = "График 4", font = ('Hevletica', 10, 'bold'), command = chart2.plot_chart)
...
btnChart2 = tk.Button(window, text = "График 5", font = ('Hevletica', 10, 'bold'), command = chart2.plot_chart)
